    ...
    <>
      ...
      <div className="header_section">
        ...
        <div className="header_left">
          ...
          <h1 className=" animated animatedFadeInUp fadeInUp banner_taital" data-wow-delay="0.1s" style={{visibility:"visible", animationDelay:"0.1s", animationName:"fadeInUp"}}> ALGO TRADE <br /> WEALTH UPGRADES</h1>
            <p className="banner_text  animated animatedFadeInUp fadeInUp  mt-3" style={{visibility:"visible", animationDelay:"0.5s", animationName:"fadeInUp"}}>
        ...
        <div className="row cnt_trd_algo">
          ...
          >
            <div className="s_l_block">
              <h2 className="sct_title what_taital" style={{textAlign:"left"}}>
          ...
          <div className="col-lg-7">
            <div className="s_r_block row pt-5 ">
              ...
              <div className="col-sm-12 col-md-6 mb-3 block_point">
                ...
                Our Platform works without direct access to your trading account to access your fund, it is totally in your control .
                </p>
              </div>
              <div className="col-sm-12 col-md-6 mb-3 block_point">
                <div className="d-flex flex-lg-row flex-flow justify-content-center">
                ...
                <p className="pnt_cnt text-center">
                To minimize the emotional strain on traders, algo trading systems keep their emotions in control and allow them to follow a strategy more easily.
                Best & Pre-tested Profitable Strategies with Real Time Execution and Zero Latency.
                </p>
              </div>
              <div className="col-sm-12 col-md-6 mb-3 block_point">
                <div className="d-flex flex-lg-row flex-flow justify-content-center">
      ...
      <div className="container">
				<div className="section-head text-center">
					...
					<h5>
            			<p className="fr_blk_cnt" style={{color:"#362465", fontSize: "15px"}}> An unique blend of opportunities to generate capital gains and get the best of both
                		worlds Intraday and Positional trading</p>
            		</h5>
				</div>
				<div className="row sp60" style={{marginBottom:"-2%"}}>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.1s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Use your funds across trades with different trading strategies.</p>
							</div>
						</div>
					</div>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.2s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							<div className="icon-media">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Choose your risk level for each strategy you follow.</p>
							</div>
						</div>
					</div>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.3s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							<div className="">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Utilize your Capital to generate a Second source of Income and enjoy profits.</p>
							</div>
						</div>
					</div>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.4s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							<div className="icon-media">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Our Platform works without direct access to your funds.</p>
							</div>
						</div>
					</div>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.5s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							<div className="icon-media">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Traders risk their own funds when providing trades for copying.</p>
							</div>
						</div>
					</div>
					<div className="col-xl-4 col-md-6 m-b60 wow fadeInUp" data-wow-delay="0.6s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeInUp"}}>
						<div className="icon-bx-wraper style-5 text-center">
							<div className="icon-media">
							...
							<div className="icon-content">
								...
								<p className="m-b0">Align demat assets with the trader’s account in one click.</p>
							</div>
						</div>
					</div>
				</div>
      ...
      {/* Client Section */}
      <div classNameName="client_section layout_padding p-5">
        <div className="container">
          <div
